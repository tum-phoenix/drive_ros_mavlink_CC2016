...
ros::Publisher  to_mav_mav_raw_data_publisher;        //! ROS publisher to write to mavlink interface
ros::Subscriber from_mav_mav_raw_data_subscriber;     //! ROS subscriber to read from mavlink interface
 ...
 *
 */            
void to_mav_notification_callback(const mavlink_phoenix::NOTIFICATION::ConstPtr& msg)
{
	...
	memcpy(&(notification_out.description), &(msg->description[0]), sizeof(char)* (int)(msg->description.size()));
	memcpy(&(notification_out.tag), &(msg->tag[0]), sizeof(char)* (int)(msg->tag.size()));

    
    mavlink_msg_notification_encode(msg->sysid, msg->compid, &m, &notification_out);
 ...
 *
 */            
void to_mav_heartbeat_callback(const mavlink_phoenix::HEARTBEAT::ConstPtr& msg)
{
...
void to_mav_debug_callback(const mavlink_phoenix::DEBUG::ConstPtr& msg)
{
	...
	memcpy(&(debug_out.data), &(msg->data[0]), sizeof(float)* (int)(msg->data.size()));
 ...
 *
 */            
void to_mav_telemetry_callback(const mavlink_phoenix::TELEMETRY::ConstPtr& msg)
{
 ...
 *
 */            
void to_mav_control_lights_callback(const mavlink_phoenix::CONTROL_LIGHTS::ConstPtr& msg)
{
	...
	memcpy(&(control_lights_out.colors), &(msg->colors[0]), sizeof(uint32_t)* (int)(msg->colors.size()));

    
    mavlink_msg_control_lights_encode(msg->sysid, msg->compid, &m, &control_lights_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_control_command_callback(const mavlink_phoenix::CONTROL_COMMAND::ConstPtr& msg)
{
    ...
    mavlink_msg_control_command_encode(msg->sysid, msg->compid, &m, &control_command_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_odometer_abs_callback(const mavlink_phoenix::ODOMETER_ABS::ConstPtr& msg)
{
    ...
    mavlink_msg_odometer_abs_encode(msg->sysid, msg->compid, &m, &odometer_abs_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_odometer_raw_callback(const mavlink_phoenix::ODOMETER_RAW::ConstPtr& msg)
{
    ...
    mavlink_msg_odometer_raw_encode(msg->sysid, msg->compid, &m, &odometer_raw_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_odometer_delta_callback(const mavlink_phoenix::ODOMETER_DELTA::ConstPtr& msg)
{
    ...
    mavlink_msg_odometer_delta_encode(msg->sysid, msg->compid, &m, &odometer_delta_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_odometer_delta_raw_callback(const mavlink_phoenix::ODOMETER_DELTA_RAW::ConstPtr& msg)
{
    ...
    mavlink_msg_odometer_delta_raw_encode(msg->sysid, msg->compid, &m, &odometer_delta_raw_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_proximity_callback(const mavlink_phoenix::PROXIMITY::ConstPtr& msg)
{
 ...
 *
 */            
void to_mav_parking_lot_callback(const mavlink_phoenix::PARKING_LOT::ConstPtr& msg)
{
 ...
 *
 */            
void to_mav_config_request_count_callback(const mavlink_phoenix::CONFIG_REQUEST_COUNT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_phoenix] Received a  'to_mav_CONFIG_REQUEST_COUNT request");
    ...
    mavlink_msg_config_request_count_encode(msg->sysid, msg->compid, &m, &config_request_count_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_config_request_callback(const mavlink_phoenix::CONFIG_REQUEST::ConstPtr& msg)
{
    ...
    mavlink_msg_config_request_encode(msg->sysid, msg->compid, &m, &config_request_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_config_request_params_callback(const mavlink_phoenix::CONFIG_REQUEST_PARAMS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_phoenix] Received a  'to_mav_CONFIG_REQUEST_PARAMS request");
    ...
    mavlink_msg_config_request_params_encode(msg->sysid, msg->compid, &m, &config_request_params_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_config_count_callback(const mavlink_phoenix::CONFIG_COUNT::ConstPtr& msg)
{
    ...
    mavlink_msg_config_count_encode(msg->sysid, msg->compid, &m, &config_count_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
...
void to_mav_config_callback(const mavlink_phoenix::CONFIG::ConstPtr& msg)
{
	...
	memcpy(&(config_out.name), &(msg->name[0]), sizeof(char)* (int)(msg->name.size()));
 ...
 *
 */            
void to_mav_config_param_int_callback(const mavlink_phoenix::CONFIG_PARAM_INT::ConstPtr& msg)
{
	...
	memcpy(&(config_param_int_out.name), &(msg->name[0]), sizeof(char)* (int)(msg->name.size()));
    ...
    mavlink_msg_config_param_int_encode(msg->sysid, msg->compid, &m, &config_param_int_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_config_param_bool_callback(const mavlink_phoenix::CONFIG_PARAM_BOOL::ConstPtr& msg)
{
	...
	memcpy(&(config_param_bool_out.name), &(msg->name[0]), sizeof(char)* (int)(msg->name.size()));
	config_param_bool_out.value = msg->value;
	config_param_bool_out.default_value = msg->default_value;

    
    mavlink_msg_config_param_bool_encode(msg->sysid, msg->compid, &m, &config_param_bool_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_config_param_float_callback(const mavlink_phoenix::CONFIG_PARAM_FLOAT::ConstPtr& msg)
{
	...
	memcpy(&(config_param_float_out.name), &(msg->name[0]), sizeof(char)* (int)(msg->name.size()));
    ...
    mavlink_msg_config_param_float_encode(msg->sysid, msg->compid, &m, &config_param_float_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_config_param_set_int_callback(const mavlink_phoenix::CONFIG_PARAM_SET_INT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_phoenix] Received a  'to_mav_CONFIG_PARAM_SET_INT request");
    ...
    mavlink_msg_config_param_set_int_encode(msg->sysid, msg->compid, &m, &config_param_set_int_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_config_param_set_bool_callback(const mavlink_phoenix::CONFIG_PARAM_SET_BOOL::ConstPtr& msg)
{
    ROS_INFO("[mavlink_phoenix] Received a  'to_mav_CONFIG_PARAM_SET_BOOL request");
    ...
    mavlink_msg_config_param_set_bool_encode(msg->sysid, msg->compid, &m, &config_param_set_bool_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void to_mav_config_param_set_float_callback(const mavlink_phoenix::CONFIG_PARAM_SET_FLOAT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_phoenix] Received a  'to_mav_CONFIG_PARAM_SET_FLOAT request");
    ...
    mavlink_msg_config_param_set_float_encode(msg->sysid, msg->compid, &m, &config_param_set_float_out);
    uint16_t len=mavlink_msg_to_send_buffer(data, &m);
    write_to_mav(data,len);
 ...
 *
 */            
void from_mav_mav_raw_data_callback(const mavlink_phoenix::MAV_RAW_DATA::ConstPtr& msg)
{
    ROS_INFO("[mavlink_phoenix] Received a  'from_mav_mav_raw_data_callback request");
	...
	memcpy(&(m.description), &(notification_in.description), sizeof(char)*50);
	...
	m.parking_lot_position = parking_lot_in.parking_lot_position;
                    ...
                    case MAVLINK_MSG_ID_CONFIG_REQUEST_COUNT:
                    {
                        ...
                        mavlink_msg_config_request_count_decode(&mav_msg, &config_request_count_in);
                    ...
                    case MAVLINK_MSG_ID_CONFIG_REQUEST_PARAMS:
                    {
                        ...
                        mavlink_msg_config_request_params_decode(&mav_msg, &config_request_params_in);
	...
	m.max = config_param_float_in.max;
                    ...
                    case MAVLINK_MSG_ID_CONFIG_PARAM_SET_INT:
                    {
                        ...
                        mavlink_msg_config_param_set_int_decode(&mav_msg, &config_param_set_int_in);
	...
	m.value = config_param_set_int_in.value;
                    ...
                    case MAVLINK_MSG_ID_CONFIG_PARAM_SET_BOOL:
                    {
                        ...
                        mavlink_msg_config_param_set_bool_decode(&mav_msg, &config_param_set_bool_in);
	...
	m.value = config_param_set_bool_in.value;
                    ...
                    case MAVLINK_MSG_ID_CONFIG_PARAM_SET_FLOAT:
                    {
                        ...
                        memset(&config_param_set_float_in, 0, sizeof(config_param_set_float_in));
                        mavlink_msg_config_param_set_float_decode(&mav_msg, &config_param_set_float_in);
...
int main(int argc, char **argv)
{
     ...
     */
	from_mav_notification_pub = n.advertise<mavlink_phoenix::NOTIFICATION>("/from_mav_notification", 10);
	from_mav_heartbeat_pub = n.advertise<mavlink_phoenix::HEARTBEAT>("/from_mav_heartbeat", 10);
	from_mav_debug_pub = n.advertise<mavlink_phoenix::DEBUG>("/from_mav_debug", 10);
	from_mav_telemetry_pub = n.advertise<mavlink_phoenix::TELEMETRY>("/from_mav_telemetry", 10);
	from_mav_control_lights_pub = n.advertise<mavlink_phoenix::CONTROL_LIGHTS>("/from_mav_control_lights", 10);
	from_mav_control_command_pub = n.advertise<mavlink_phoenix::CONTROL_COMMAND>("/from_mav_control_command", 10);
	from_mav_imu_pub = n.advertise<mavlink_phoenix::IMU>("/from_mav_imu", 10);
	from_mav_odometer_abs_pub = n.advertise<mavlink_phoenix::ODOMETER_ABS>("/from_mav_odometer_abs", 10);
	from_mav_odometer_raw_pub = n.advertise<mavlink_phoenix::ODOMETER_RAW>("/from_mav_odometer_raw", 10);
	from_mav_odometer_delta_pub = n.advertise<mavlink_phoenix::ODOMETER_DELTA>("/from_mav_odometer_delta", 10);
	from_mav_odometer_delta_raw_pub = n.advertise<mavlink_phoenix::ODOMETER_DELTA_RAW>("/from_mav_odometer_delta_raw", 10);
	from_mav_odometer_pub = n.advertise<mavlink_phoenix::ODOMETER>("/from_mav_odometer", 10);
	from_mav_proximity_pub = n.advertise<mavlink_phoenix::PROXIMITY>("/from_mav_proximity", 10);
	from_mav_parking_lot_pub = n.advertise<mavlink_phoenix::PARKING_LOT>("/from_mav_parking_lot", 10);
	from_mav_config_request_count_pub = n.advertise<mavlink_phoenix::CONFIG_REQUEST_COUNT>("/from_mav_config_request_count", 10);
	from_mav_config_request_pub = n.advertise<mavlink_phoenix::CONFIG_REQUEST>("/from_mav_config_request", 10);
	from_mav_config_request_params_pub = n.advertise<mavlink_phoenix::CONFIG_REQUEST_PARAMS>("/from_mav_config_request_params", 10);
	from_mav_config_count_pub = n.advertise<mavlink_phoenix::CONFIG_COUNT>("/from_mav_config_count", 10);
	from_mav_config_pub = n.advertise<mavlink_phoenix::CONFIG>("/from_mav_config", 10);
	from_mav_config_param_int_pub = n.advertise<mavlink_phoenix::CONFIG_PARAM_INT>("/from_mav_config_param_int", 10);
	from_mav_config_param_bool_pub = n.advertise<mavlink_phoenix::CONFIG_PARAM_BOOL>("/from_mav_config_param_bool", 10);
	from_mav_config_param_float_pub = n.advertise<mavlink_phoenix::CONFIG_PARAM_FLOAT>("/from_mav_config_param_float", 10);
	from_mav_config_param_set_int_pub = n.advertise<mavlink_phoenix::CONFIG_PARAM_SET_INT>("/from_mav_config_param_set_int", 10);
	from_mav_config_param_set_bool_pub = n.advertise<mavlink_phoenix::CONFIG_PARAM_SET_BOOL>("/from_mav_config_param_set_bool", 10);
	from_mav_config_param_set_float_pub = n.advertise<mavlink_phoenix::CONFIG_PARAM_SET_FLOAT>("/from_mav_config_param_set_float", 10);
	from_mav_command_pub = n.advertise<mavlink_phoenix::COMMAND>("/from_mav_command", 10);

    /**
     * Messages Subscribers Declaration
     */
	ros::Subscriber to_mav_notification_sub = n.subscribe("/to_mav_notification", 10, to_mav_notification_callback);
	...
	ros::Subscriber to_mav_telemetry_sub = n.subscribe("/to_mav_telemetry", 10, to_mav_telemetry_callback);
	ros::Subscriber to_mav_control_lights_sub = n.subscribe("/to_mav_control_lights", 10, to_mav_control_lights_callback);
	ros::Subscriber to_mav_control_command_sub = n.subscribe("/to_mav_control_command", 10, to_mav_control_command_callback);
	ros::Subscriber to_mav_imu_sub = n.subscribe("/to_mav_imu", 10, to_mav_imu_callback);
	ros::Subscriber to_mav_odometer_abs_sub = n.subscribe("/to_mav_odometer_abs", 10, to_mav_odometer_abs_callback);
	ros::Subscriber to_mav_odometer_raw_sub = n.subscribe("/to_mav_odometer_raw", 10, to_mav_odometer_raw_callback);
	ros::Subscriber to_mav_odometer_delta_sub = n.subscribe("/to_mav_odometer_delta", 10, to_mav_odometer_delta_callback);
	ros::Subscriber to_mav_odometer_delta_raw_sub = n.subscribe("/to_mav_odometer_delta_raw", 10, to_mav_odometer_delta_raw_callback);
	ros::Subscriber to_mav_odometer_sub = n.subscribe("/to_mav_odometer", 10, to_mav_odometer_callback);
	ros::Subscriber to_mav_proximity_sub = n.subscribe("/to_mav_proximity", 10, to_mav_proximity_callback);
	ros::Subscriber to_mav_parking_lot_sub = n.subscribe("/to_mav_parking_lot", 10, to_mav_parking_lot_callback);
	ros::Subscriber to_mav_config_request_count_sub = n.subscribe("/to_mav_config_request_count", 10, to_mav_config_request_count_callback);
	ros::Subscriber to_mav_config_request_sub = n.subscribe("/to_mav_config_request", 10, to_mav_config_request_callback);
	ros::Subscriber to_mav_config_request_params_sub = n.subscribe("/to_mav_config_request_params", 10, to_mav_config_request_params_callback);
	ros::Subscriber to_mav_config_count_sub = n.subscribe("/to_mav_config_count", 10, to_mav_config_count_callback);
	ros::Subscriber to_mav_config_sub = n.subscribe("/to_mav_config", 10, to_mav_config_callback);
	ros::Subscriber to_mav_config_param_int_sub = n.subscribe("/to_mav_config_param_int", 10, to_mav_config_param_int_callback);
	ros::Subscriber to_mav_config_param_bool_sub = n.subscribe("/to_mav_config_param_bool", 10, to_mav_config_param_bool_callback);
	ros::Subscriber to_mav_config_param_float_sub = n.subscribe("/to_mav_config_param_float", 10, to_mav_config_param_float_callback);
	ros::Subscriber to_mav_config_param_set_int_sub = n.subscribe("/to_mav_config_param_set_int", 10, to_mav_config_param_set_int_callback);
	ros::Subscriber to_mav_config_param_set_bool_sub = n.subscribe("/to_mav_config_param_set_bool", 10, to_mav_config_param_set_bool_callback);
	ros::Subscriber to_mav_config_param_set_float_sub = n.subscribe("/to_mav_config_param_set_float", 10, to_mav_config_param_set_float_callback);
	ros::Subscriber to_mav_command_sub = n.subscribe("/to_mav_command", 10, to_mav_command_callback);
